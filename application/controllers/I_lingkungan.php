				...
				if (0 < $_FILES['file']['error']) {
					...
					if ($this->upload->do_upload('file')) {
						...
						if ($this->input->post('id_izin') == "") {
							...
							$q_data = $this->Mglobals->getAllQR("select NVL(MAX(substr(ID_PENGAJUAN,'3','7')),0) + 1 as jml from PENGAJUAN_IZIN_LINGKUNGAN ");
							// var_dump($nilai);
							$data_input = array(
	...
	//                    
		...
		public function hapus() {
			if (get_cookie('status') == "login") {
				...
				// $hapus = $this->Mglobals->delete("PENGAJUAN_IZIN_LINGKUNGAN", $kond);
				// if($hapus == 1){
