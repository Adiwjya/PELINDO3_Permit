...
<script type="text/javascript">
	...
	function send_response() {
		...
		if (data_mi == null) {
			...
			data_mi = data_mi.substring(2, data_mi.length);
			destination_mi = destination_mi.substring(2, destination_mi.length);
		}
		...
		if (status == "") {
			...
			if (status == "1" || status == "2") {
				url = "<?php echo base_url(); ?>vertifikasi_izin/save_memerlukan_izin";
			}else{
