<script type="text/javascript">
	...
	function tambah(){
        window.location.href = "<?php echo base_url(); ?>i_pengerukan/new_add";
    }
	
	function ganti(id){
        window.location.href = "<?php echo base_url(); ?>i_pengerukan/new_add/"+id;
    }
	...
	function response(id) {
		...
		// alert(id);
		$.ajax({
            url : "<?php echo base_url(); ?>i_pengerukan/load_response/" + id,
            type: "POST",
            dataType: "JSON",
				...
				<div class="kt-portlet__head">
					<div class="kt-portlet__head-label">
						<h3 class="kt-portlet__head-title mr">
							Data Pengajuan Izin Pengerukan
						</h3>
					</div>
					<div class="kt-portlet__head-label">
